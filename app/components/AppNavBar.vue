    ...
    <div class="bg-white">
      <div class="flex h-14 items-center justify-between gap-8 px-4 sm:px-6">
        <div class="flex items-center gap-4">
          ...
          <div v-if="!isHome"
            class="hidden md:flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3 py-1.5 focus-within:border-slate-400 focus-within:bg-white transition">
